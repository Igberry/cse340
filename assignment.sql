...
ALTER TABLE IF EXISTS public.inventory ADD CONSTRAINT 
 fk_classification FOREIGN KEY (classification_id)
...
Select inv_make , inv_model, classification_name from classification INNER JOIN inventory ON   inventory.classification_id = classification.classification_id  where classification_name = 'Sports';
